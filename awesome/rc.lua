...
beautiful.init("/home/jayc0b0/.config/awesome/theme.lua")
...
awful.util.spawn("killall kshutdown")
...
-- {{{ apw
-- Load the widget.
-- @13 local APW = require("apw/widget")

-- Example: Add to wibox. Here to the right. Do it the way you like it.
-- @199 right_layout:add(APW)

-- Configure the hotkeys.
-- @282 awful.key({ }, "XF86AudioRaiseVolume",  APW.Up)
-- awful.key({ }, "XF86AudioLowerVolume",  APW.Down)
-- awful.key({ }, "XF86AudioMute",         APW.ToggleMute)
-- }}}
